...
module Data.HES.Messages.ReadStreamEventsCompleted (ReadStreamEventsCompleted(..)) where
import Prelude ((+), (/))
import qualified Prelude as Prelude'
import qualified Data.Typeable as Prelude'
import qualified Data.Data as Prelude'
import qualified Text.ProtocolBuffers.Header as P'
import qualified Data.HES.Messages.ReadStreamEventsCompleted.ReadStreamResult as HES.Messages.ReadStreamEventsCompleted
       (ReadStreamResult)
import qualified Data.HES.Messages.ResolvedIndexedEvent as HES.Messages (ResolvedIndexedEvent)
